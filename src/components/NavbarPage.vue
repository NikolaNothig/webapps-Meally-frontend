    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <h1 class="nav-link"><router-link to="/profile">Profile</router-link></h1>
          </li>
          <li class="nav-item">
            <h1 class="nav-link"><router-link to="/create">Create Recipe</router-link></h1>
          </li>
        ...
        <div class="ml-auto">
          <router-link v-if="isLoggedIn" to="/login" @click="logout" class="btn btn-primary btn-lg">
            Logout
          </router-link>
