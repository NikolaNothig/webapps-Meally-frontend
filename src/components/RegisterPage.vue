    ...
    <div class="d-grid container-fluid bt-3 mt-3">
      <div class="row d-grid align-content-center justify-content-center">
        ...
        <form @submit.prevent="register">
          ...
          <div>
            <input v-model="password" type="password" class="mb-3 form-select-lg text-bg-" id="password" placeholder="Password">
          </div>
          <div>
      ...
      <div class="row">
        <div>
          <h3 class="text-center">Already have an account? <a href="../login" class="text text-decoration-none">Log in.</a></h3>
        </div>
        <div>
